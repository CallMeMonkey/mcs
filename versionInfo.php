...
<div class="content floatRight" style="color: #454e62;" id="content">
    ...
    <!--3.4.6-->
    <h3><i class="fas fa-info-circle" style="margin-right: 10px;"></i>版本：3.4.6</h3>
    <ul style="margin: 10px;">
        <li>修复显示错误</li>
        <li>更新归纳导出功能</li>
    </ul>
    <!--3.4.5-->
    <h3><i class="fas fa-info-circle" style="margin-right: 10px;"></i>版本：3.4.5</h3>
    <ul style="margin: 10px;">
        <li>优化后台代码</li>
    </ul>
    <!--3.4.4-->
    <h3><i class="fas fa-info-circle" style="margin-right: 10px;"></i>版本：3.4.4</h3>
    <ul style="margin: 10px;">
        <li>更新系统监控功能</li>
        <li>优化后台代码</li>
        <li>添加监控所需文件</li>
    ...
    <!--3.4.3-->
    <h3><i class="fas fa-info-circle" style="margin-right: 10px;"></i>版本：3.4.3</h3>
    <ul style="margin: 10px;">
        <li>更新数据备份后台功能</li>
    </ul>
    <!--3.4.2-->
